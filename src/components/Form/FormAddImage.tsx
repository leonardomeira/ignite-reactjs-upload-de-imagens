    ...
    try {
      if (!imageUrl) {
        toast({
          ...
          description: 'E preciso adicionar e aguardar o upload de uma imagem antes de realizar o cadastro'
        });
      ...
      toast({
        ...
        description: 'A sua imagem foi cadastrada com sucesso!'
      });
